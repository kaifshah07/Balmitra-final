...
exports.sendFranchiseEnquiryEmail = sendFranchiseEnquiryEmail;
const brevo_1 = require("@getbrevo/brevo");
exports.brevo = new brevo_1.BrevoClient({
...
async function sendOtpEmail(email, name, otp) {
    try {
        ...
        console.log("OTP:", otp);
        const result = await exports.brevo.transactionalEmails.sendTransacEmail({
            sender: {
                name: "Balmitra",
...
async function sendFranchiseEnquiryEmail(enquiry) {
    try {
        ...
        console.log("✅ Franchise enquiry email sent successfully");
        console.log("Message ID:", result.messageId);
        return result;
    }
    catch (error) {
        console.error("❌ FRANCHISE BREVO ERROR:");
        console.error("Message:", error?.message);
        console.error("Status:", error?.statusCode);
        console.error("Body:", error?.body);
        throw new Error(error?.message ||
